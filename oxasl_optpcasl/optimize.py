...
class Optimizer(object):
    ...
    def gridsearch(self, gridpts=1e6):
        ...
        while 1:
            param_ranges = [
                np.linspace(bounds[0], bounds[1], grid_npts) for bounds in param_bounds
            ]
            ...
            self.log.write(
                " - Iteration %i: best cost: %.5f params: %s\n"
        ...
        self.log.write(
            " - Initializing with parameters: %s\n" % self._params2str(best_params)
        )
        self.log.write("DONE")
